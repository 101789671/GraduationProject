...
public class DocConverter {
	...
	private String outputPath = ServletActionContext.getRequest().getRealPath("/docs");// 输出路径 ，如果不设置就输出在默认的位置 (与源文件位置相同)
	 ...
	 * @param fileString  源文件路径
	 * @param outputPath 输出路径
	 * @param OpenOffice_Home OpenOffice 安装路径
	 * @param pdf2swf_home  Swftools安装路径
	 */
	...
	*/  
	private void ini(String fileString) {  
		...
		fileName = fileString.substring(0, fileString.lastIndexOf("."));  //从0 到最后的.
