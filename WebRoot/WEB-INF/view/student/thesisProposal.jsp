...
<body onload="javascript : document.listform.reset()">
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong class="icon-reorder">开题报告</strong>
		</div>
		<div class="padding border-bottom">
			<ul class="search" style="padding-left:10px;">
				<li class="text">开题报告上传</li>
			</ul>
			<div id="Divss" class="Divss">
				<div id="Divs_1" class="uploadFileDiv">

					<form
						action="<%=path%>/system/File_uploadFile.action?gpFile.fileCatNum=TP"
		...
		<table class="table table-hover text-center">
			...
			<s:iterator id="item" value="gpFileList" status="i">
				<tr>
					...
					<td><s:if test="%{#item.fileState=='最新'}">new </s:if>
					</td>
					<td>${fileCategory}</td>
					<td>${fileName}</td>
					<td>${uploadTime}</td>
