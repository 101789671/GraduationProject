					...
					<tr>
						...
						<td><div class="button-group">
								<a class="button border-main"
									href="<%=path %>/tut/Tutor_handleCT.action?apply.apId=${apId}&apply.apState=agree" onclick="Sonedel();">
									<span class="icon-edit"></span> 同意</a> 
									<a class="button border-red"
									href="<%=path %>/tut/Tutor_handleCT.action?apply.apId=${apId}&apply.apState=disagree" onclick="Sonedel();">
