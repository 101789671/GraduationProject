...
<body>   
	<div class="panel admin-panel">
		...
		<div class="personalDataS">
		  <div class="personalDatas"> <div class="personalData1">导师编号:</div> <div class="personalData2">${tutNo}</div></div>
		  <div class="personalDatas"> <div class="personalData1">姓名:</div> <div class="personalData2">${tutName}</div></div>
		  ...
		  <div class="personalDatas"> <div class="personalData1">职称:</div> <div class="personalData2">${position}</div></div>
		</div>
		</s:iterator>
</body>
