...
<body>
	...
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong class="icon-reorder">开题报告/概况</strong>
		</div>
		<form action="<%=path %>/download/download_downloadFile.action">
			<div class="padding border-bottom">
				...
				<li>
					<a class="button border-red" href="<%=path %>/tut/Tutor_studentAllGPDatum.action?gpFile.fileCatNum=TP&seat=2"> <span
				...
				<tr>
					...
					<td><div class="button-group">
						...
						<a class="button border-main"
							...
							下载</a> 
							<a class="button border-red"
								href="<%=path %>/tut/Tutor_someStudentMoreGPDatum.action?gpFile.uploaderId=${uploaderId}&gpFile.fileCatNum=TP"
								><span class="icon-edit"></span>
							更多</a>
						</div>
					</td>
