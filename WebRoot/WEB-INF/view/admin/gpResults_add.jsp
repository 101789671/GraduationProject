...
<body>
	<div class="panel admin-panel">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>成绩录入</strong>
		</div>
		
		<div id="Divss" class="Divss">
			<div id="Divs_1" class="uploadFileDiv">
			
				<form action="<%=path%>/system/File_importGpResults.action"
		...
		<form method="post" class="form-x" id="myform"
				action="<%=path%>/system/gpResults_addGpReluts.action">
					...
					<div class="form-group">
						...
						<div class="field">
							<select class="input w50" name="gpResults.reTypeName">
							<option>开题答辩</option>
							<option>毕业论文</option>
							<option>毕业设计</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" id="gpResults.tutName"
								 name="gpResults.tutName"  />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" id="gpResults.majorName"
								name="gpResults.majorName"  />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" id="gpResults.groupingsNo"
