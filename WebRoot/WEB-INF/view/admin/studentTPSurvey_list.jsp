	...
	<div class="panel admin-panel">
		...
		<form action="<%=path %>/download/download_downloadFile.action">
			<div class="padding border-bottom">
				...
				<li>
					<a class="button border-red" href="<%=path %>/admin/Admin_studentAllGPDatum.action?gpFile.fileCatNum=TP"> <span
					...
					<td><div class="button-group">
						...
						<a class="button border-main"
							...
							<a class="button border-red"
								href="<%=path %>/admin/Admin_someStudentMoreGPDatum.action?student.stuNo=${uploaderId}&gpFile.fileCatNum=TP"
								><span class="icon-edit"></span>
							更多</a>
						</div>
					</td>
