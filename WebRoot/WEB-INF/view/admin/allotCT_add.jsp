...
<body>
	<div class="panel admin-panel">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>人工分配</strong>
		</div>
		<div class="body-content">

			<c:forEach items="${studentList}" var="student">
				<form method="post" class="form-x" id="myform"
					action="<%=path%>/system/Apply_allotApply.action?apID=${apId}">
					<div class="form-group">
						...
						<div class="field">
							<input  type="text" class="input w50"
								id="studentForm.stuNo" value="${student.stuNo}"
								name="studentForm.stuNo" readOnly="true" data-validate="required:请输入编号" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" id="studentForm.stuName"
								value="${student.stuName}" name="studentForm.stuName" readOnly="true"
					...
					<div class="form-group">
						...
						<div class="field">
							<select class="input w50" name="studentForm.sex" readOnly="true"
								id="studentForm.sex">
								<option
									<c:if test="${student.sex =='男'}"> selected="selected" </c:if>>男</option>
								<option
									<c:if test="${student.sex =='女'}"> selected="selected" </c:if>>女</option>
							</select>
							<div class="tips"></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="field">
							<select class="input w50" name="studentForm.instituteName"
								id="studentForm.instituteName" onchange=updateOption2(); readOnly="true">
							</select> <select class="input w50" name="studentForm.className"
								id="studentForm.className"  readOnly="true">
							</select>
					...
					<div class="form-group">
						...
						<div class="field">
							<select class="input w50" name="tutorForm.instituteName"
								id="tutorForm.instituteName" onchange=updateOption3();><option></option>
							</select> 
							<select class="input w50" name="studentForm.tutName"
								id="studentForm.tutName">
								<option></option>
							</select>
							<div class="tips"></div>
						</div>
