...
<body onload="javascript : document.listform.reset()">
	<form method="post"
		action="<%=path %>/system/Apply_toAllotApply.action" id="listform"
		name="listform">
		<div class="panel admin-panel">
			...
			<div class="padding border-bottom">
				<ul class="search" style="padding-left:10px;">
					...
					<li><a class="button border-main" href="<%=path %>/system/Apply_recordCD.action"> <span
							class="icon-edit"></span> 申请记录</a></li>
							<li><input type="button" name="button" value="自动分配" onclick="batchAllot();"  class="button border-red"/></li>
					<li>搜索：</li>
					...
					<tr>
						...
						<td><div class="button-group">
								<a class="button border-main"
									...
									<span class="icon-edit"></span> 人工分配</a> 
							</div></td>
					</tr>
				</s:iterator>
			</table>
