...
<body onload="javascript : document.listform.reset()">
	<form method="post"
		action="<%=path%>/system/Class_findclassAll.action" id="listform"
		name="listform">
		<div class="panel admin-panel">
			...
			<div class="padding border-bottom">
				<ul class="search" style="padding-left:10px;">
					<li><a class="button border-main icon-plus-square-o"
						href="<%=path%>/system/Class_toaddclass.action"> 添加班级</a>
					</li>
					<li>
				
					<input type="submit" name="button" value="删除" onclick="batchDelCal();"  class="button border-red"/></li>
					<li>搜索：</li>
			...
			<table class="table table-hover text-center">
				...
				<s:iterator id="item" value="reclassList" status="i">
					<tr>
						<td style="text-align:left; padding-left:20px;"><input
							type="checkbox" name="SubCheck" value="${classNo}"
						...
						<td><div class="button-group">
								<a class="button border-main"
									href="<%=path%>/system/Class_toUpdataclass.action?classNo=${classNo}">
									<span class="icon-edit"></span> 修改</a> <a class="button border-red"
									href="<%=path%>/system/Class_delclass.action?myclass.classNo=${classNo}"
