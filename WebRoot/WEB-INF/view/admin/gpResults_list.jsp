		...
		<div class="padding border-bottom">
			<ul class="search" style="padding-left:10px;">
				<form method="post" name="findanserGrouping" id="findanserGrouping"
					action="<%=path%>/system/gpResults_listGpResults.action?">
				...
				<form method="post"
					...
					<li><input type="submit" name="button" value="批量删除"
						onclick="batchDelGpResults();" class="button border-red" />
					</li>
					<li>搜索：</li>
			...
			<s:iterator id="item" value="gpResultsList" status="i">
				<tr>
					<td style="text-align:left; padding-left:20px;"><input
						type="checkbox" name="SubCheck" value="${resultsNo}"
					...
					<td><div class="button-group">
							<a class="button border-main"
								href="<%=path%>/admin/Admin_toUpdateGpResults.action?gpResults.resultsNo=${resultsNo}">
								<span class="icon-edit"></span> 修改</a> <a class="button border-red"
								href="<%=path%>/system/gpResults_deleteGpResults.action?gpResults.resultsNo=${resultsNo}"
