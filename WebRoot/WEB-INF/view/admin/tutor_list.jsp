	...
	<form method="post"
		...
		<div class="panel admin-panel">
			<div class="panel-head">
				<strong class="icon-reorder">添加导师 </strong>
			</div>
			<div class="padding border-bottom">
				<ul class="search" style="padding-left:10px;">
					<li><a class="button border-main icon-plus-square-o"
						href="<%=path%>/system/Student_toaddStu.action"> 添加导师</a>
					</li>
					<li>
					<input type="submit" name="button" value="删除" onclick="batchDelTu();"  class="button border-red"/>
				</li>
					<li>搜索：</li>
					...
					<tr>
						...
						<td><div class="button-group">
								<a class="button border-main"
									href="<%=path %>/system/Tutor_toUpdateTu.action?tutor.tutNo=${tutNo}">
									<span class="icon-edit"></span> 修改</a> 
									<a class="button border-red"
									href="<%=path %>/system/Tutor_delTuOne.action?tutor.tutNo=${tutNo}"
